...
public class SetorSeguro extends Setor {
	...
	// instância das infromações para o atendimento do setor de seguro
	// automotivo
	private Informe informacao = new Informe("SEGURO AUTOMOTIVO", "10:00 às 17:00", "Lorena Assion", "Sala 3A");
